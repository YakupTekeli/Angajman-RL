...
**Kamikaze-Drone-Swarm-Engagement** (formerly Angajman-RL) is an advanced Multi-Agent Reinforcement Learning (MARL) project designed to simulate and train a swarm of autonomous drones for coordinated kamikaze attacks. The project utilizes a hierarchical control system combining a global **Swarm Coordinator** for high-level strategy and individual **RL Agents** for low-level tactical execution.
...
cd Kamikaze-Drone-Swarm-Engagement
